    ...
    return(
        <div className='cocAcademicContainer'>
            ...
            <div className='cocAcademicContents'>
                ...
                <div className='UMCAcademicTransferSchduleWrapper'>
                    <div className='cocAcademicTransferContent'>
                        <div className='cocAcademicTransferTag'>
                        ...
                        <div className='cocAcademicTransferText'>
                            Discuss students’ future path with the counselors and students’ parents. (which will affect your electives and your credits)<br/>
                            適應環境，參加活動，就是普通的校園生活，<strong>準備開始填寫志願</strong>
                        </div>
                    </div>
                    ...
                    <div className='cocAcademicTransferContent'>
                        <div className='cocAcademicTransferTag'>
                            <h3>Winter Semester<br/></h3>
                            <h4>1月 - 2月</h4>
                        </div>

                        <div className='cocAcademicTransferText'>
                            Application season. At the same time continue school and work.<br/>
                            <strong>During fall & winter: Volunteer, Extra-curricular…</strong>
                        </div>
                    </div>
                    ...
                    <div className='cocAcademicTransferContent'>
                        <div className='cocAcademicTransferTag'>
                            <h3>Spring Semester<br/></h3>
                            <h4>3月 - 6月</h4>
                        </div>

                        <div className='cocAcademicTransferText'>
                            Wait & complete your application (if you move on to the 2nd stage and have interviews…)
                            Complete all credits and requirements
                            After receiving the offer, accept
                            Then youre good 👍
                            <strong>*since the university looks at all grade 12 grades, you should not let go of any courses you are taking, till the end even you get an offer or send out applications</strong>
                        </div>
                    </div>
