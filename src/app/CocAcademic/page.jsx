...
export default function CocAcademicPage() {
  const mailtoLink =
    "mailto:isp@canyons.edu?subject=Questions%20regarding%20online%20classes&body=Dear%20ISP%20Office,%0D%0A%0D%0AI%20am%20an%20online%20student%20from%20Hui-Wen%20High%20School.%0D%0AI%20have%20some%20questions%20regarding%20IGETC%20and%20which%20classes%20I%20should%20register%20for.%0D%0ACould%20I%20schedule%20an%20appointment%20with%20AJ%20or%20receive%20guidance%20on%20course%20selection?%0D%0A%0D%0AThank%20you%20for%20your%20assistance.%0D%0A%0D%0ASincerely,%0D%0A[你的名字]";
  return (
    <div className={styles.cocAcademicContainer}>
      <div className={styles.cocAcademicHero}>
        <img
          className={styles.cocAcademicBackground}
          src="/UCtransfer/calGate2.jpg"
          alt="COC Campus"
          loading="lazy"
        />
        <h1 className={styles.cocAcademicTitle}>
          UC轉學指南：課程、GPA與規劃、線上課程
        </h1>
      </div>
      <div className={styles.cocAcademicContents}>
        <DividerContent
          order="一"
          title="COC課堂基本資訊"
        ...
        <div className={styles.cocAcademicOnlineClassWrapper}>
          <p>
            假如你是現在惠文的在校生要選修COC的線上課程，跟Daniel討論後可以前往ISP網站申請，以下有列出常見的申請時間及該注意的截止日期
            ，選課時間大多都在開課時間3個月前，所以一旦拿到帳號必須馬上前往選課，第一個學期推薦先修
            <strong>COUNS-150</strong>熟悉作業系統及課程
            <br />
            <strong>
              *拿到錄取信/申請成功後，當學期一定要選課，不然又要重來
            </strong>
          </p>
          <div className={styles.cocAcademicOnlineContent}>
            ...
            <div className={styles.cocAcademicTransferText}>
              <ul>
                <li>
                  <strong>Fall Semester</strong> - 開課時間約為 8 月底，6
                  月以前就要送出申請，8月才可以上課
                </li>
                <li>
                  <strong>Spring Semester</strong> - 開課時間約為 2 月中旬，12
                  月以前就要送出申請，隔年2月才可以上課
                </li>
                <li>申請審核時間 - 一般審核作業時間：最多約需 10 個工作天</li>
              </ul>
            </div>
          </div>
          <div className={styles.cocAcademicOnlineContent}>
            ...
            <div className={styles.cocAcademicTransferText}>
              ...
              進入點選左上角"My Registration"然後"My Registration Time
            </div>
          </div>
          <div className={styles.cocAcademicOnlineContent}>
            <div className={styles.cocAcademicTransferTag}>
            ...
            <div className={styles.cocAcademicTransferText}>
              IGETC（州際通識轉學課程）幫助社區大學學生轉入UC或CSU時，
              滿足大部分通識教育要求。課程涵蓋數學、科學、人文、社會科學及英文寫作，
              多數也有線上選項，方便彈性學習。
              <br />從
              <a
                href="https://my.canyons.edu/campusm/home#menu"
              ...
              進入，點擊My Academic Plan(MAP)就可以看到My progress，在"At a
              Glance"上方的箭頭右邊會有Program name，
              找到"IGETC"，下方就是各式各樣推薦線上先修的課，詳細請詢問
        ...
        <DividerContent order="四" title="學業相關" />

        <div className={styles.cocAcademicCardContainer}>
          <div className={styles.cocAcademiccard}>
            <div className={styles.cocAcademicIconBox}>
              <img
                src="/UCtransfer/consultant.png"
                alt="icon"
                className={styles.cocAcademicIcon}
              />
              <div className={styles.cocAcademicCardTitle}>
                Counselor <br />
                (AJ、Amy)
              </div>
              <div className={styles.cocAcademicCardsubtitle}>課程顧問</div>
            </div>
            <div className={styles.cocAcademicCardText}>
              <ul>
                <li>課程規劃與排課</li>
                <li>學分查詢與認證</li>
                <li>轉學流程與規劃</li>
          ...
          <div className={styles.cocAcademiccard}>
            <div className={styles.cocAcademicIconBox}>
              <img
                src="/UCtransfer/TLC.png"
                alt="icon"
                className={styles.cocAcademicIcon}
              />
              <div className={styles.cocAcademicCardTitle}>TLC</div>
              <div className={styles.cocAcademicCardsubtitle}>The Learning Center</div>
            </div>
            <div className={styles.cocAcademicCardText}>
              <ul>
                <li>提供免費學習輔導、研討會</li>
                ...
                <li>
                  數學、物理、化學等理科直接問Chat GPT比較有效果 或直接去Office
                  Hour找教授
                </li>
              </ul>
            </div>
          ...
          <div className={styles.cocAcademiccard}>
            <div className={styles.cocAcademicIconBox}>
              <img
                ...
                className={styles.cocAcademicIcon}
              />
              <div className={styles.cocAcademicCardTitle}>Office Hour</div>
              <div className={styles.cocAcademicCardsubtitle}>課後討論</div>
            </div>

            <div className={styles.cocAcademicCardText}>
              <ul>
                <li>
                  教授每週固定開放的時間，學生可以自由前往討論課程內容、詢問問題或請求協助
                </li>
        ...
        <div className={styles.cocAcademicTransferContentWrapper}>
          <div className={styles.cocAcademicTransferContent}>
            ...
            <div className={styles.cocAcademicTransferText}>
              ...
              不適用競爭科系(各學校不同)如: Computer Science、Electronic
              Engineering…
            </div>
          </div>
          ...
          <div className={styles.cocAcademicTransferContent}>
            ...
            <div className={styles.cocAcademicTransferText}>
              查詢轉學學分可使用
              Assist.org，這是加州官方認可的平台，用來確認社區大學課程是否符合
              UC/CSU 系統的轉學要求。 只要輸入目前就讀的學校（如
              COC）以及目標轉入的大學與科系，即可查看該科系的 Lower Division
              課程需求、可轉學分及對應課程建議，
        ...
        <div className={styles.cocAcademicExtraSourcesWeapper}>
          <div className={styles.cocAcademicExtraSourceCard}>
            <a
              href="https://docs.google.com/presentation/d/1v22vKciJu_YPj59gESPB3wkFJgER2mwMowQZ3ekCtW8/mobilepresent?slide=id.p"
              target="_blank"
            >
              <h3>Guide To UC Transfer</h3>
              <h4>
                這是我申請時參考的PIQ指南，裡面有更加詳細的介紹，以及對於每題PIQ的分析
              </h4>
            </a>
          </div>
          ...
          <div className={styles.cocAcademicExtraSourceCard}>
            <a
              href="https://admission.universityofcalifornia.edu/admission-requirements/transfer-requirements/"
              target="_blank"
            >
              <h3>UC Transfer Official Page</h3>
              <h4>
                這是UC的官方網站，裡面包含PIQ、時程表、Tools、更加詳細的規定介紹
              </h4>
            </a>
          </div>
