...
function SeniorsContent() {
  ...
  return (
    <div className={styles.PPLContainer}>
      <div className={styles.PPLSideSection}>
        <div className={`${styles.seniorSideBar} SIDEBAR`}>
          <span className={styles.seniorSideBarTitle}>學校/School</span>
          <ul>
      ...
      <div className={styles.Seniorsarea}>
        <h1 className={styles.seniorTitle} ref={titleRef}>
          學長姐們
        </h1>
        ...
        <div
          className={`${styles.accordionWrapper} ${
            highlightSchool === "COC" ? styles.highlight : ""
          }`}
        >
          <PPLaccordionItem
        ...
        <div
          className={`${styles.accordionWrapper} ${
            highlightSchool === "UMC" ? styles.highlight : ""
          }`}
        >
          <PPLaccordionItem
            School="UMC"
        ...
        <div
          className={`${styles.accordionWrapper} ${
            highlightSchool === "RedDeer" ? styles.highlight : ""
          }`}
        >
          <PPLaccordionItem
            School="Red Deer"
        ...
        <span className={styles.invisibleTitle} ref={otherRef}>
          Others
        </span>
        ...
        <div className={styles.PPLdivider} />
        <div className={styles.PPLColdEmail}>
          <h2 className={styles.seniorTitle}>Cold Email/聯繫學長姊Tips</h2>
          <div className={styles.PPLColdEmailText}>
            在北美，「Reach
          ...
          <div className={styles.PPLColdEmailExampleWrapper}>
            <h3 className={styles.PPLColdEmailExampleTitle}> Cold Email Examples</h3>

            <div className={styles.PPLColdEmailExampleText}>
              範例 1：請教建議／尋求指導
              <br />
              主旨：想請教您關於[主題/領域]的經驗
              <br />
