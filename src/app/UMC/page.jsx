...
export default function UMCPage() {
  ...
  const prosConsData = [
    [
      "體驗加拿大環境，換新的環境探索自我",
      "師資好，比較開放，更傾向跟學生討論，授課品質高",
      "課程內容貼近個人興趣－類似大學輔導老師/以申請大學為目標的規劃",
      "程選擇靈活/有辦法探索各式領域",
      "師生關係親近",
      "以本地生的資格申請大學，不用跟國際生競爭",
      "人數少，較易取得職位與參與機會，有利於申請資料準備",
      {
        title: "社交生活多樣化",
        items: ["建立更廣泛的交友圈", "提前融入多元交流的環境"],
      },
    ],
    [
      "相較於惠文，硬體資源相對匱乏",
      "台灣人與亞洲學生約佔60%，容易待在舒適圈。",
      "學生素質落差大，不少紈褲子弟",
      "校園與周邊娛樂選擇有限",
      "一天內天氣多變，感覺像是經歷四季，冬天會有雪。",
      "老師流動率高",
      "學餐品質起伏大",
      "沒有 AP IB課程",
    ],
      ...
      <main className={styles["main-content"]}>
        <div className={styles["content-section"]}>
          ...
          <p className={styles["description-text"]}>
            ...
            P.S. 由於澳洲大學對於加拿大私立高中文憑的政策改變，大學想藉由UMC申請
            <strong>澳洲大學</strong>要多交考慮、跟Daniel討論。
          </p>
          ...
          <ProsCons data={prosConsData} color={["#af292e"]} />
        </div>
        <div className={styles.divider} />
      </main>
